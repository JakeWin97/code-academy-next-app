...
const RAboutDetail:React.FC <IAboutDetail> = ({ header, line1, line2, line3, image, alt }) => {
    return (
        <div className="flex w-full bg-white mb-4 rounded-2xl bg-blue-500">
